...
export const BarSmall = ({ filterCl, setFilterCl, ciudades }) => {
    ...
    return (
        <div className='barSearchCl'>
            <button type='button' className='buton-search' onClick={() => {
                setFilterCl(!filterCl);
            }}><VscListFilter />  Busqueda Avanzada</button>

            <div className={`${filterCl ? 'active' : 'desative'}`}>
                ...
                <button type='submit' className='buton-search'>
                    Buscar
                </button>
            </div>
