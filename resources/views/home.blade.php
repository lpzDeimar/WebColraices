...
<head>
    ...
    <meta itemprop="telephone" content="+573105653998">
    <meta property="og:title" content="Compra tu casa en Colombia desde el exterior - Colraices" />
...
<script>
  window.callbellSettings = {
    token: "MibRnary8FioEkbMMBZXpfc6"
  };
</script>
<script>
...
<!-- End of Async Callbell Code -->
    <div id="app"></div>
    <input type="hidden" value={{ $location->countryCode}} id="contry">
